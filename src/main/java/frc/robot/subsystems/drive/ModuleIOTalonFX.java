  ...
  public ModuleIOTalonFX(int index) {
    switch (index) {
      case 0:
        ...
        absoluteEncoderOffset = new Rotation2d(-1.971 + Math.PI / 2); // MUST BE CALIBRATED
        break;
      case 1:
        driveTalon = new TalonFX(6);
        turnTalon = new TalonFX(7);
        cancoder = new CANcoder(12);
        absoluteEncoderOffset = new Rotation2d(1.290 + Math.PI / 2); // MUST BE CALIBRATED
        break;
      case 2:
        driveTalon = new TalonFX(2);
        turnTalon = new TalonFX(3);
        cancoder = new CANcoder(10);
        absoluteEncoderOffset = new Rotation2d(2.168 + Math.PI / 2); // MUST BE CALIBRATED
        break;
      case 3:
        driveTalon = new TalonFX(4);
        turnTalon = new TalonFX(5);
        cancoder = new CANcoder(11);
        absoluteEncoderOffset = new Rotation2d(2.214 + Math.PI / 2); // MUST BE CALIBRATED
        break;
      default:
