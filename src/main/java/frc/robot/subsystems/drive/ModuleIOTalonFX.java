  ...
  public ModuleIOTalonFX(int index) {
    switch (index) {
      case 0:
        ...
        absoluteEncoderOffset = new Rotation2d(-0.108); // MUST BE CALIBRATED
        break;
      case 1:
        driveTalon = new TalonFX(13);
        turnTalon = new TalonFX(18);
        cancoder = new CANcoder(22);
        absoluteEncoderOffset = new Rotation2d(2.052); // MUST BE CALIBRATED
        break;
      case 2:
        driveTalon = new TalonFX(15);
        turnTalon = new TalonFX(16);
        cancoder = new CANcoder(21);
        absoluteEncoderOffset = new Rotation2d(2.147); // MUST BE CALIBRATED
        break;
      case 3:
        driveTalon = new TalonFX(17);
        turnTalon = new TalonFX(10);
        cancoder = new CANcoder(20);
        absoluteEncoderOffset = new Rotation2d(1.250); // MUST BE CALIBRATED
        break;
      default:
