...
public class Test {
  ...
  private static final HashMap<String, Pose2d> APRILTAG_RADIAN = new HashMap<String, Pose2d>();
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        "hello"
            + APRILTAG_RADIAN.get(asd).getX()
            + "|"
            + APRILTAG_RADIAN.get(asd).getY()
            + "|"
            + APRILTAG_RADIAN.get(asd).getRotation());
  }
}
